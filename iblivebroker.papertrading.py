...
class LiveFeed(barfeed.BaseBarFeed):
    ...
    def __init__(self, identifiers, frequency, host="localhost", port=7497, maxLen=dataseries.DEFAULT_MAX_LEN, marketOptions={'assetType': 'STK', 'currency': 'GBP', 'routing': 'SMART'}, warmupBars=0, debug=False):
        ...
        self.__queue = _queue.SimpleQueue()
        self.__currentBar = {}
